...
class surface_element_const_iterator
{
 public:
  surface_element_const_iterator(const std::size_t                       ielement,
                                 const angem::PointSet<3,Scalar>             & vertices,
                                 const std::vector<std::vector<std::size_t>> & polygons,
                                 const EdgeMap                               & map_edges,
                                 const std::vector<int>                & grid_markers);

  // assignment operator
  surface_element_const_iterator<Scalar> & operator=(const surface_element_const_iterator<Scalar> & other);
  // comparison operators
  bool operator==(const surface_element_const_iterator<Scalar> & other) const;
  bool operator!=(const surface_element_const_iterator<Scalar> & other) const;
  // incrementing/decrementing
  surface_element_const_iterator<Scalar> & operator++();
  surface_element_const_iterator<Scalar> & operator--();
  // Getters
  inline std::size_t index() const {return ielement;}
  inline int marker() const { return _grid_markers[ielement]; }
  std::vector<surface_element_const_iterator<Scalar>> neighbors() const;
 ...
 private:
  std::size_t                             ielement;
  const angem::PointSet<3,Scalar>             & mesh_vertices;
  const std::vector<std::vector<std::size_t>> & polygons;
  const EdgeMap                               & map_edges;
  const std::vector<int>                & _grid_markers;
};


template <typename Scalar>
surface_element_const_iterator<Scalar>::
surface_element_const_iterator(const std::size_t                       ielement,
                                 const angem::PointSet<3,Scalar>             & vertices,
                                 const std::vector<std::vector<std::size_t>> & polygons,
                                 const EdgeMap                               & map_edges,
...
template <typename Scalar>
surface_element_const_iterator<Scalar> & surface_element_const_iterator<Scalar>::operator++()
{
  ielement++;
  return *this;
}
...
template <typename Scalar>
bool surface_element_const_iterator<Scalar>::
operator==(const surface_element_const_iterator<Scalar> & other) const
{
...
surface_element_const_iterator<Scalar>::edges() const
{
...
template <typename Scalar>
std::vector<angem::Point<3,Scalar>> surface_element_const_iterator<Scalar>::vertex_coordinates() const
{
