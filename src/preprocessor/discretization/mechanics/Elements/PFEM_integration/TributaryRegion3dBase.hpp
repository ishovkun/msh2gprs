...
class TributaryRegion3dBase {
 public:
  ...
  inline const std::vector<std::size_t> & cells(const size_t region_index) const noexcept
  {
  ...
  inline const std::vector<std::size_t> & cells_center() const noexcept {return _cells_center;}
 ...
 protected:
  ...
  // vector: region index -> list of cells
